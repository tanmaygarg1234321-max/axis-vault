      ...
      html = `
        ...
        <head>
          <style>
            ...
            .logo { font-size: 28px; font-weight: bold; color: #f59e0b; }
            .card { background: #18181b; border-radius: 16px; padding: 32px; margin-bottom: 24px; border: 1px solid #f59e0b33; }
            .content { color: #e5e5e5; line-height: 1.8; font-size: 16px; }
            .footer { text-align: center; color: #71717a; font-size: 12px; margin-top: 40px; }
            .divider { height: 1px; background: linear-gradient(90deg, transparent, #f59e0b, transparent); margin: 24px 0; }
            .cta-button { display: inline-block; background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); color: #000000; text-align: center; padding: 14px 28px; border-radius: 8px; font-weight: 700; text-decoration: none; margin-top: 20px; }
            a { color: #f59e0b; }
          </style>
        </head>
        <body>
          <div class="container">
            ...
            <div class="card">
              ...
              <div style="text-align: center; margin-top: 20px;">
                <a href="https://discord.com/invite/f3NJw7ZJDw" style="color: #f59e0b;">💬 Join our Discord Community</a>
              </div>
            </div>
            <div class="footer">
              <p style="margin-bottom: 8px;"><a href="https://axis-sparkle-store.lovable.app">Visit Store</a> • <a href="https://discord.com/invite/f3NJw7ZJDw">Discord</a></p>
              <p>© ${new Date().getFullYear()} Axis Economy Store. All rights reserved.</p>
              <p style="margin-top: 12px; font-size: 11px;">You're receiving this because you made a purchase at Axis Economy Store.</p>
            </div>
          </div>
        </body>
        </html>
